...
3. **The recommender is not the collaborative filter.** No model is trained, and
   the NDCG target is not claimed. The only interaction data available is
   synthetic, and reporting a metric from it would be meaningless.
