...
(function () {
    ...
    var T = {
        en: {
            ...
            feat2t: 'Fraud Detection', feat2d: 'Duplicate scan validation built-in',
            ...
            scope2: 'Category classifier trained & integrated; fraud, anomaly & recommender models in progress.',
            ...
            s2t: '🔍 Extract — OCR', s2d: 'The backend forwards the image to the ML microservice, where a 5-layer OCR pipeline runs: a blur check (OpenCV Laplacian), a rate-limit gate, Google Gemini 2.5 Flash extraction, a model fallback, and a pixel-density scan that flags handwritten edits.',
            s3t: '🧠 Classify & Detect', s3d: 'The extracted fields flow through the ML models — a TF-IDF + Random Forest category classifier, a fraud scorer (OCR signals + duplicate perceptual hashing), and an Isolation-Forest spending-anomaly check.',
            s4t: '🎁 Reward & Recommend', s4d: 'The points engine computes ₹100 = 1 point, scaled by spend category, user tier and streak. Points, fraud scores and personalised offers are written to Firestore and returned to your screen.',
        ...
        ar: {
            ...
            feat2t: 'كشف الاحتيال', feat2d: 'التحقق من المسح المكرّر مدمج',
            ...
            scope2: 'مُصنِّف الفئات مُدرَّب ومُدمَج؛ نماذج الاحتيال والشذوذ والتوصية قيد التطوير.',
            ...
            s2t: '🔍 الاستخراج — OCR', s2d: 'يمرّر الخادم الصورة إلى خدمة تعلّم الآلة حيث يعمل خط معالجة OCR من 5 طبقات: فحص التشويش (OpenCV Laplacian)، بوّابة الحد من المعدّل، استخراج Google Gemini 2.5 Flash، نموذج احتياطي، وفحص كثافة البكسل لرصد التعديلات المكتوبة بخط اليد.',
            s3t: '🧠 التصنيف والكشف', s3d: 'تمرّ الحقول المستخرجة عبر نماذج تعلّم الآلة — مُصنِّف فئات TF-IDF + Random Forest، ومُقيِّم احتيال (إشارات OCR + التجزئة الإدراكية للمكرّرات)، وفحص شذوذ الإنفاق Isolation-Forest.',
            s4t: '🎁 المكافأة والتوصية', s4d: 'يحسب محرّك النقاط ₹100 = نقطة واحدة، مع تعديلها حسب فئة الإنفاق ومستوى المستخدم والسلسلة. تُكتب النقاط ودرجات الاحتيال والعروض المخصّصة في Firestore وتُعاد إلى شاشتك.',
        ...
        hi: {
            ...
            feat2t: 'धोखाधड़ी पहचान', feat2d: 'डुप्लिकेट स्कैन सत्यापन अंतर्निहित',
            ...
            scope2: 'श्रेणी क्लासिफायर प्रशिक्षित और एकीकृत; धोखाधड़ी, विसंगति और अनुशंसा मॉडल प्रगति पर।',
            ...
            s2t: '🔍 एक्सट्रैक्ट — OCR', s2d: 'बैकएंड छवि को ML माइक्रोसर्विस को भेजता है, जहाँ 5-लेयर OCR पाइपलाइन चलती है: ब्लर जाँच (OpenCV Laplacian), रेट-लिमिट गेट, Google Gemini 2.5 Flash एक्सट्रैक्शन, मॉडल फ़ॉलबैक, और हस्तलिखित बदलावों को चिह्नित करने वाला पिक्सेल-डेंसिटी स्कैन।',
            s3t: '🧠 वर्गीकरण और पहचान', s3d: 'निकाले गए फ़ील्ड ML मॉडलों से गुज़रते हैं — TF-IDF + Random Forest श्रेणी क्लासिफायर, एक फ्रॉड स्कोरर (OCR संकेत + डुप्लिकेट perceptual hashing), और Isolation-Forest खर्च-विसंगति जाँच।',
            s4t: '🎁 इनाम और अनुशंसा', s4d: 'पॉइंट्स इंजन ₹100 = 1 पॉइंट की गणना करता है, जो खर्च श्रेणी, उपयोगकर्ता टियर और स्ट्रीक के अनुसार समायोजित होता है। पॉइंट्स, फ्रॉड स्कोर और व्यक्तिगत ऑफ़र Firestore में लिखे जाते हैं और आपकी स्क्रीन पर लौटाए जाते हैं।',
        ...
        ml: {
            ...
            feat2t: 'തട്ടിപ്പ് കണ്ടെത്തൽ', feat2d: 'ഡ്യൂപ്ലിക്കേറ്റ് സ്കാൻ പരിശോധന അന്തർനിർമ്മിതം',
            ...
            scope2: 'വിഭാഗ ക്ലാസിഫയർ പരിശീലിപ്പിച്ച് സംയോജിപ്പിച്ചു; തട്ടിപ്പ്, അപാകത, ശുപാർശ മോഡലുകൾ പുരോഗമിക്കുന്നു.',
            ...
            s2t: '🔍 എക്‌സ്‌ട്രാക്റ്റ് — OCR', s2d: 'ബാക്കെൻഡ് ചിത്രം ML മൈക്രോസർവീസിലേക്ക് കൈമാറുന്നു, അവിടെ 5-ലെയർ OCR പൈപ്പ്‌ലൈൻ പ്രവർത്തിക്കുന്നു: ബ്ലർ പരിശോധന (OpenCV Laplacian), റേറ്റ്-ലിമിറ്റ് ഗേറ്റ്, Google Gemini 2.5 Flash എക്‌സ്‌ട്രാക്ഷൻ, മോഡൽ ഫാൾബാക്ക്, കൈയക്ഷര മാറ്റങ്ങൾ കണ്ടെത്തുന്ന പിക്‌സൽ-ഡെൻസിറ്റി സ്കാൻ.',
            s3t: '🧠 വർഗ്ഗീകരണവും കണ്ടെത്തലും', s3d: 'വേർതിരിച്ച ഫീൽഡുകൾ ML മോഡലുകളിലൂടെ കടന്നുപോകുന്നു — TF-IDF + Random Forest വിഭാഗ ക്ലാസിഫയർ, ഒരു ഫ്രോഡ് സ്കോറർ (OCR സൂചനകൾ + ഡ്യൂപ്ലിക്കേറ്റ് perceptual hashing), Isolation-Forest ചെലവ്-അപാകത പരിശോധന.',
            s4t: '🎁 റിവാർഡും ശുപാർശയും', s4d: 'പോയിന്റ്സ് എഞ്ചിൻ ₹100 = 1 പോയിന്റ് കണക്കാക്കുന്നു, ചെലവ് വിഭാഗം, ഉപയോക്തൃ ടയർ, സ്ട്രീക്ക് എന്നിവയനുസരിച്ച് ക്രമീകരിക്കുന്നു. പോയിന്റുകൾ, ഫ്രോഡ് സ്കോറുകൾ, വ്യക്തിഗത ഓഫറുകൾ Firestore-ൽ എഴുതി നിങ്ങളുടെ സ്ക്രീനിലേക്ക് തിരികെ നൽകുന്നു.',
        ...
        zh: {
            ...
            scope2: '类别分类器已训练并集成；欺诈、异常与推荐模型开发中。',
            ...
            s2t: '🔍 提取 — OCR', s2d: '后端将图片转发到 ML 微服务，运行五层 OCR 流程：模糊检测（OpenCV Laplacian）、限流闸门、Google Gemini 2.5 Flash 提取、模型回退，以及标记手写改动的像素密度扫描。',
            s3t: '🧠 分类与检测', s3d: '提取的字段流经 ML 模型——TF-IDF + Random Forest 类别分类器、欺诈评分器（OCR 信号 + 重复感知哈希）以及 Isolation-Forest 消费异常检测。',
            s4t: '🎁 奖励与推荐', s4d: '积分引擎按 ₹100 = 1 分计算，并根据消费类别、用户等级与连续打卡进行调整。积分、欺诈分数与个性化优惠写入 Firestore 并返回到你的屏幕。',
            archTitle: '幕后 — 架构',
